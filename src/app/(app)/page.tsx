...
export default function EventsPage() {
  ...
  // This state is managed by the layout now, but we need to pass the setter
  // This is a bit of a workaround because the filter is in the layout
  // A better solution would involve context or a global state manager
  ...
  return (
    <>
    {/* The actual filter is in the layout, we pass the state up via a prop drill workaround */}
